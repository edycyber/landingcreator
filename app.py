...
API_KEY = 'AIzaSyA5Id4uuQuZLDdpfZZeMwa1ZhtSAaItUdI'
...
def main():
    ...
    st.subheader('Only paste your image and wait second for the magic [Sign out](https://edycyber.github.io/landingcreator/)')
